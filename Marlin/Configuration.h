 ...
 */
#define Z_STEPS      1596 // Stock lead screw
 ...
 * Set both to 0 (zero) if you do not have a Z-Probe.
 */
#define XTRA_BED_FRONT    20  // Distance bed can move towards the front past Y = 200 (Y=280 for large bed)
